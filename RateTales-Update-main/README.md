...
|-------------------|------------------------------------------------|
| **Ghofur A.M**      | [🌐 Profile](https://github.com/Ghof-AM) |
| **Evelyn P.S**      | [🌐 Profile](https://github.com/SIMOXE3) |
| **Alfiansyah W.P**  | [🌐 Profile](https://github.com/020206)    |

---

## 📝 Deskripsi
This repository is the collaborative work of **Kelompok 5** for the **PROJECT-GEA**. It includes:
...
1. Clone this repository locally:
   ```bash
   git clone https://github.com/Ghof-AM/PROJECT-GEA.git
